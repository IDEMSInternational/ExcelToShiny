...
box_function <- function(data_frame, spreadsheet, unique_ID, label_table, label_plot){
  ...
  if (type == "bar_table"){
    ...
    return_object <- bar_table(data = data, variable = variable, type = "freq")
  } else if (type == "bar_summary"){
    return_object <- bar_table(data = data, variable = variable, type = "summary")
  } else if (type == "boxplot_freq"){
    return_object <- boxplot_table(data = data, variable = variable, type = "freq")
  } else if (type == "boxplot_summary"){
    return_object <- boxplot_table(data = data, variable = variable, type = "summary")
  }
